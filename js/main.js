function draw_cuadrado() {
  ...
  function draw_moverPluma() {
    const canvas = document.getElementById("canvas_moverPluma");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_CurvasCuadraticasBézier() {
    const canvas = document.getElementById("canvas_CurvasCuadraticasBézier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_CurvasCubicasBézier() {
    const canvas = document.getElementById("canvas_CurvasCubicasBézier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_ConvinacionesR() {
    const canvas = document.getElementById("canvas_ConvinacionesR");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  draw_lineas();
  draw_arcos();
  draw_CurvasCuadraticasBézier();
  draw_CurvasCubicasBézier();
  draw_ConvinacionesR();
  draw_Path2D();